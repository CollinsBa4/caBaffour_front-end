...
insert into quizmasters (fname, lname, user_password, isadmin, username) values ('Robbey', 'Brooks', 'nQMvCPB83gRw', false, 'gbrooks6');
insert into quizmasters (fname, lname, user_password, isadmin, username) values ('Necolds', 'Burborough', 'QTZwWkHjuuiM', false, 'tburborough7');
insert into quizmasters (fname, lname, user_password, isadmin, username) values ('Dionisii', 'Poulson', 'T9MSUt', false, 'opoulson8');
insert into quizmasters (fname, lname, user_password, isadmin, username) values ('MacSkeagan', 'Leith', 'TzYoKhPfcB2', false, 'jleith9');
...
insert into quizmasters (fname, lname, user_password, isadmin, username) values ('Frohock', 'Pendred', 'gaVACW', false, 'apendredc');
insert into quizmasters (fname, lname, user_password, isadmin, username) values ('Streeter', 'Parrett', 'oDw3j9gxIpI',false, 'lparrettd');
insert into quizmasters (fname, lname, user_password, isadmin, username) values ('Hinners', 'Birch', 'H4TDZqStyb64', false, 'mbirche');
...
insert into quizmasters (fname, lname, user_password, isadmin, username) values ('Magrannell', 'Ridhole', 'G7N9An', false, 'dridholeh');
insert into quizmasters (fname, lname, user_password, isadmin, username) values ('Hoy', 'Youle', 'qxueZY', false, 'kyoulei');
insert into quizmasters (fname, lname, user_password, isadmin, username) values ('Kinker', 'Chaff', 'SCEyhlkfbDC', false, 'echaffj');
;